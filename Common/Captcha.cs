...
public class Captcha
{
    ...
    public static CaptchaResult DrawCaptchaImage(int width, int height, string captchaCode)
    {
        if (!OperatingSystem.IsWindowsVersionAtLeast(6,1))
            throw new PlatformNotSupportedException("drawing captcha is only available in windows v6.1 or later.");
